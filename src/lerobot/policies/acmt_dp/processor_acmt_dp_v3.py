...
from .configuration_acmt_dp_v3 import ACMTDPV3Config, depth_key, rgb_key
from .gripper_mapping import ACMTDPGripperGPOProcessorStep
from .visual_preprocess import prepare_for_frozen_encoder


@dataclass
@ProcessorStepRegistry.register(name="acmt_dp_v3_center480_processor")
class ACMTDPV3Center480ProcessorStep(ObservationProcessorStep):
...
ACMTDPWristROIProcessorStep = ACMTDPV3Center480ProcessorStep


def make_acmt_dp_v3_pre_post_processors(
    config: ACMTDPV3Config,
